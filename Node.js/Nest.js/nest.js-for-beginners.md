...
<details>
<summary>2.5 Setting up prisma</summary>

## 2.5 Setting up prisma
...
npx prisma init
```
This command will create the necessary configuration files for Prisma, including the `.env` file with default values.
